...
if (global.left_mouse) {
	switch(global.arma_player_atual){
		case ak47: global.tempo_arma_player_atual = 0.2
		case pistola: global.tempo_arma_player_atual = 0.5
	}
	// Sistema de tiro refeito
	if global.tempo_jogo - global.ultima_bala >= global.tempo_arma_player_atual{
		var bala
		if image_xscale < 0 {
